# lms-canvas-blueprint-manager
Allows an instructor to configure blueprint courses in Canvas.
...
<tr><td>Initiate login URL</td><td>http://localhost:8080/lti/login_initiation/lms_lti_blueprint</td></tr>
